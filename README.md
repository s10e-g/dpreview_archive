...
By default, this script will only archive Studio scene(1), Video Stills Comparison(131), Raw DR: ISO-invariance(630) and Raw DR: Exposure Latitude(631). You can edit line 134 to archive images from other tools, but this script may not work on some of them.

Here is the (hopefully) complete list of currently available tools (unique `sceneId`) on DPReview:

| widget | sceneId | sceneTitle | Note |
| ------ | ------- | ---------- | ---- |
| 1 | 1 | Studio scene |  |
| 21 | 6 | Connect Studio Scene | Smartphones |
| 47 | 7 | Shadow Noise Comparison |  |
| 67 | 9 | Video Stills Comparison |  |
